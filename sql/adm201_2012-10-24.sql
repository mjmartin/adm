...
# Database: adm201
# Generation Time: 2012-10-24 22:05:06 +0000
# ************************************************************
...
CREATE TABLE `Marks` (
  ...
  `Question` int(11) NOT NULL,
  `answer_list` varchar(1024) DEFAULT NULL,
...
INSERT INTO `Marks` (`id`, `Round`, `Question`, `answer_list`, `is_correct`)
VALUES
	(1,1,2,'[]',1),
	(2,1,111,'[]',1),
	(3,1,22,'[\"92\",\"91\"]',0),
...
VALUES
	...
	(29,'Which statement about Community experts is true?\r\nChoose 2 answers:',2,'A community expert is a member of the community who speaks credibly and authoritatively on behalf of your organization.\n\nWhen a community expert posts a comment or idea, a unique icon (Community Expert Icon) displays next to his or her name so other community members can easily identify credible information within the community. The Salesforce administrator can designate as many community experts as necessary.',0,1),
...
INSERT INTO `Rounds` (`id`, `round_start`, `round_end`, `correct`, `wrong`, `created_at`, `unanswered`)
VALUES
	(1,'2012-10-23 12:55:59','2012-10-23 20:43:13',1,0,'2012-10-23 19:02:54',99);
