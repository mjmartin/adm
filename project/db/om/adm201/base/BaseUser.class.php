...
class BaseUser extends \nano\core\db\om\Base {
	...
	public function setId($value){
		if(\project\db\om\adm201\User::validateId($value)){
			$this->id = $value;
		} else {
	...
	public function setLanguage($value){
		if(\project\db\om\adm201\User::validateLanguage($value)){
			$this->language = $value;
		} else {
	...
	public function setEmail($value){
		if(\project\db\om\adm201\User::validateEmail($value)){
			$this->email = $value;
		} else {
	...
	public function setPassword($value){
		if(\project\db\om\adm201\User::validatePassword($value)){
			$this->password = $value;
		} else {
	...
	public function setIsActive($value){
		if(\project\db\om\adm201\User::validateIsActive($value)){
	...
	public function setIsAdmin($value){
		if(\project\db\om\adm201\User::validateIsAdmin($value)){
			$this->is_admin = $value;
		} else {
	...
	public function setIsSuperAdmin($value){
		if(\project\db\om\adm201\User::validateIsSuperAdmin($value)){
	...
	public function setCreatedAt($value){
		if(\project\db\om\adm201\User::validateCreatedAt($value)){
	...
	public function setUpdatedAt($value){
		if(\project\db\om\adm201\User::validateUpdatedAt($value)){
